...
function use_env {
  ...
  echo "Using environment variables from ${ENV_FILE} to start containers"
	make up
  # Not sure why this is necessary, but I left it in for now.
