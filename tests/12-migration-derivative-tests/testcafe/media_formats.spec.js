...
import { navigateToItemPage } from './util.js';
...
test('Upload tiff in UI', async t => {
    ...
    const file = await download("http://migration-assets/assets/image/formats/tiff.tif")
...
test('Upload jpeg 2000 in UI', async t => {
    ...
    const file = await download("http://migration-assets/assets/image/formats/jp2.jp2")
