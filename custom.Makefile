...
## IDC ► Destroy the state of the Drupal site
destroy-state:
...
## IDC ► Create a snapshot docker image
snapshot-image:
	${MAKE} db_dump
	docker-compose stop
...
.PHONY: dev-up
.SILENT: dev-up
## IDC ► Start the development environment
...
.PHONY: dev-down
.SILENT: dev-down
## IDC ► Stop the development environment
...
## IDC ► Used for testing the CICD build process locally.
...
## IDC ► Updates codebase folder to be owned by the host user and nginx group.
set-codebase-owner:
	@echo ""
